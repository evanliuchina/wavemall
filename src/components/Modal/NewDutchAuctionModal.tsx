...
export default function NewDutchAuctionModal(props) {
  ...
  const [floorPriceInNEW, setFloorPriceInNEW] = useState(0)
  ...
  const onConfirm = e => {
    ...
    const amount = 1
    const strategy = DUTCH_AUCTION_CONTRACT_ADDRESS
  ...
  function onUserChangeFloorPrice(e) {
    const _newPrice = Number(e.target.value)
    if (_newPrice === Infinity || isNaN(_newPrice) || _newPrice >= 100000000000 || _newPrice <= 0) {
      return
    }
    setFloorPriceInNEW(_newPrice)
  }
                ...
                <main>
                  ...
                  <div className="group">
                    ...
                    <NumberFormat
                      ...
                      id="end_time"
                    />
                    <label htmlFor="price">{t('floor price')}</label>
                    <div className="mt-1 flex">
                      <input
                        onChange={onUserChangeFloorPrice}
                        defaultValue={0}
                        autoComplete="off"
                        type="text"
                        inputMode="decimal"
